...
export const groupsIcon = [
  ...
  },
  {
    ...
    items: [
      {
        name: priorityIcons[0].name,
        icon: priorityIcons[0].icon,
      },
      {
        name: priorityIcons[1].name,
        icon: priorityIcons[1].icon,
      },
      {
        name: priorityIcons[2].name,
        icon: priorityIcons[2].icon,
      },
      {
        name: priorityIcons[3].name,
        icon: priorityIcons[3].icon,
      },
      {
        name: priorityIcons[4].name,
        icon: (
          <svg
            width="16"
            height="16"
